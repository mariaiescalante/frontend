...
import { loadStudentProfile, saveStudentProfile } from './studentStorage';
        ...
        >
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, minmax(0, 1fr))', gap: '18px' }}>
            <label className="form-group" style={{ marginBottom: 0 }}>
              ...
              <input className="form-input" value={profile.name} disabled style={{ background: '#f1f5f9' }} />
            </label>
            ...
            <label className="form-group" style={{ marginBottom: 0 }}>
              ...
              <input className="form-input" value={profile.lastname} disabled style={{ background: '#f1f5f9' }} />
            </label>
            ...
            <label className="form-group" style={{ marginBottom: 0 }}>
              ...
              <input className="form-input" value={profile.cedula} disabled style={{ background: '#f1f5f9' }} />
            </label>
            ...
            <label className="form-group" style={{ marginBottom: 0 }}>
              ...
              <input className="form-input" type="date" value={profile.birthDate} disabled style={{ background: '#f1f5f9' }} />
            </label>
            ...
            <label className="form-group" style={{ marginBottom: 0 }}>
              ...
              <input className="form-input" value={profile.email} disabled style={{ background: '#f1f5f9' }} />
            </label>
          ...
          >
            <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
              <div>
                ...
                <strong style={{ color: '#0f172a', fontSize: '1.1rem' }}>{profile.career}</strong>
                <p style={{ margin: '4px 0 0 0', color: '#64748b', fontSize: '0.85rem' }}>
                  Facultad de {profile.faculty}
                </p>
              </div>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, minmax(0, 1fr))', gap: '12px' }}>
                <div style={{ background: '#f8fafc', border: '1px solid #e2e8f0', borderRadius: '14px', padding: '14px' }}>
                  ...
                  <strong style={{ color: '#0f172a', fontSize: '0.9rem' }}>{profile.director}</strong>
                </div>
                <div style={{ background: '#f8fafc', border: '1px solid #e2e8f0', borderRadius: '14px', padding: '14px' }}>
                  <span style={{ display: 'block', fontSize: '0.7rem', color: '#64748b', textTransform: 'uppercase', fontWeight: 700, letterSpacing: '0.08em' }}>Periodo Ingreso</span>
                  <strong style={{ color: '#0f172a', fontSize: '0.9rem' }}>{profile.admissionPeriod}</strong>
                </div>
              </div>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '14px 0', borderTop: '1px solid #e2e8f0', borderBottom: '1px solid #e2e8f0' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                  ...
                  <div>
                    ...
                    <strong style={{ color: '#0f172a', fontSize: '1.05rem' }}>{profile.cum.toFixed(2)}</strong>
                  </div>
                </div>
